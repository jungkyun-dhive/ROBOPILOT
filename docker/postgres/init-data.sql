...
-- 4. 미션 데이터 (6개)
INSERT INTO missions (id, name, site_id, site_name, robot_id, robot_name, type, schedule, status, path, start_time, end_time, created_at, updated_at)
VALUES
    -- FPT 하노이 - 보안 순찰
    ('mission-fpt-hn-01', '본사 건물 보안 순찰', 'site-fpt-hanoi', 'FPT 하노이 본사',
    ...
    -- FPT 호치민 - 시설 점검
    ('mission-fpt-hcm-01', '지사 시설 정기 점검', 'site-fpt-hcm', 'FPT 호치민 지사',
    ...
    -- 현대중공업 울산 - 대형 구조물 점검
    ('mission-hhi-uls-01', '크레인 구조 안전 점검', 'site-hhi-ulsan', '울산 조선소',
    ...
    -- 현대중공업 군산 - 해양 환경 모니터링
    ('mission-hhi-gun-01', '해양 환경 모니터링', 'site-hhi-gunsan', '군산 조선소',
    ...
    -- SK텔레콤 본사 - 통신탑 점검
    ('mission-skt-seo-01', '5G 기지국 안테나 점검', 'site-skt-ttower', 'T타워 본사',
    ...
    -- SK텔레콤 판교 - 네트워크 테스트
    ('mission-skt-pan-01', '무선 네트워크 커버리지 테스트', 'site-skt-pangyo', '판교 R&D 센터',
...
-- 5. 사용자 데이터 (샘플)
-- 비밀번호는 모두 'password123' (실제 운영에서는 암호화된 값 사용)
